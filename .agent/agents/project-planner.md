...
3. **Check .agent/plans/:** If plan file exists, READ IT FIRST

> 🔴 **CRITICAL PRIORITY:**
> 
> **Conversation history > .agent/plans/* > Any files > Folder name**
> 
...
| Existing plan in .agent/plans/ | Read and CONTINUE it, don't restart |
